...
export const Legend:FC<LegendProps> = (props)=> {
  ...
  return (
  <div className='absolute z-[500] w-fit rounded-md bg-base-200 border-gray-500 border border-solid left-none right-0 bottom-10 m-3 mb-6 md:left-10 md:right-none md:bottom-0 md:mb-3 py-2 px-4'>
